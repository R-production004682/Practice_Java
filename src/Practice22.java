public class Practice22
{
    public static void main(String[] args) 
    {
        ...
        {
        	resultScore 	 += points[i];
        	averageNumber = (double)resultScore / 100;
        }
        System.out.print("平均点 : " + averageNumber + "\n");
        System.out.print("ヒストグラム\n");
        
        //ヒストグラム
        for(var i = 0; i < 10; i++)
        {
        	//点数表記
        	if(i == 0) {System.out.print("0点台");}
        	else 		  {System.out.print((i * 10) + "点台");}
        	
        	for(var j = 0; j < points.length; j++)
        	{
        		if(points[j] >= (i * 10) && points[j] < ((i + 1) * 10)) {System.out.print("*");}
        		
        		//100点だった場合
        		if(i == 9 && points[j] == 100) {System.out.print("*");}
        	}
        	System.out.println();
        }
